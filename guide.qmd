...
![](images/clipboard-3668155184.png)

-   In the Farm tab, wait for the page to load. You should be able to see the different plots of total farms per year, total farms per year by type, Local Moran's I (LISA) and Cluster Type Maps. You can also configure your analysis on the left sidebar by setting the options below:

    -   Type of Farm (Cultivation, Livestock, Fishing)

    -   Year (From 2012 to 2023)

    -   Format of Graph (Boxplot, Line Graph, Bar Chart)
